...
class CareerRecommend(KnowledgeEngine):
    ...
    def choose_whatever(self):
        self.msg_buffer.append("The student can choose whatever he wishes.")
    ...
    def not_science_engineer(self):
        self.msg_buffer.append("The student shouldn't study science or engineering.")
    ...
    @Rule(
        NOT(AND(
            ...
            Category(natural='C'))))
    def not_health(self):
        self.msg_buffer.append("The student shouldn't choose health.")
